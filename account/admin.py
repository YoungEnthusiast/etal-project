    ...
    fieldsets = (
            *UserAdmin.fieldsets,
            (
                "Custom Fields",
                {
                    'fields': ('type', 'photograph', 'affiliation_name', 'user_Id', 'followers', 'followings', 'affiliation_address', 'bell_unreads', 'past_collaborators', 'city', 'state', 'country')
                }
            )
        )
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('username', 'password1', 'password2', 'first_name', 'user_Id', 'followers', 'followings', 'last_name', 'type', 'photograph', 'past_collaborators', 'affiliation_name', 'affiliation_address', 'bell_unreads', 'city', 'state', 'country')}
        ),
    )
