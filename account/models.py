...
class Researcher(AbstractUser):
    ...
    institution_name = models.CharField(max_length=255, blank=True, null=True, verbose_name="Institution Name")
    institution_location = models.CharField(max_length=255, blank=True, null=True, verbose_name="Institution Location")
    course = models.CharField(max_length=150, blank=True, null=True, verbose_name="Course of Study")
    year = models.CharField(max_length=9, blank=True, null=True, verbose_name="Year of Graduation")
    ...
    publication_number = models.CharField(max_length=45, blank=True, null=True, verbose_name="Number of Publications")
    patent_number = models.CharField(max_length=45, blank=True, null=True, verbose_name="Number of Patents")
    chapter = models.CharField(max_length=45, blank=True, null=True, verbose_name="Number of Book Chapters")
    textbooks = models.CharField(max_length=2000, blank=True, null=True, verbose_name="Number of Textbooks Written (List Titles)")
    google = models.CharField(max_length=255, blank=True, null=True, verbose_name="Google Scholar Profile Link")
    grants = models.CharField(max_length=45, blank=True, null=True, verbose_name="Number of Grants Awarded")
    award3 = models.CharField(max_length=45, blank=True, null=True, verbose_name="Award")
