...
class PostListView(LoginRequiredMixin, UserPassesTestMixin, SuccessMessageMixin, FormMixin, ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                obj = form.save(commit=False).author = request.user
                obj.save()
    ...
    #     return reverse_lazy( 'post_list', kwargs={'author': author.username})
